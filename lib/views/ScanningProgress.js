...
export class ScanningProgress {
  ...
  constructor(statusButton) {
    ...
    Store.on(STORE_KEYS.scanningFolder, (eventData) => {
      window.requestAnimationFrame(() => {
        this.onChangeScanningFolder(eventData);
      });
    });
  ...
  show() {
    ...
    console.log('ScanningProgress.js, show [39]: ', { item });
  }
  ...
  hide() {
    ...
    console.log('ScanningProgress.js, hide [51]: ');
  }
