...
export class MarkerOverlay {
  ...
  element = null;
  markerID = null;
  onClickIgnoreLine = null;
  onClickIgnoreFile = null;
  ...
  update(model) {
    ...
    this.onClickIgnoreLine = model.onClickIgnoreLine;
    this.onClickIgnoreFile = model.onClickIgnoreFile;
  ...
  renderContent(model) {
    ...
    const showButtons = (model !== SEVERITY.info);
    if (showButtons) {
