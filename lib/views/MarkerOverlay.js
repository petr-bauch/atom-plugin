...
export class MarkerOverlay {
  ...
  renderContent(model) {
    ...
    btnIgnoreLine.onclick = () => Store.emit(CUSTOM_EVENTS.ignoreProblem, { markerID, forFile: false });
    ...
    btnIgnoreFile.onclick = () => Store.emit(CUSTOM_EVENTS.ignoreProblem, { markerID, forFile: true });
