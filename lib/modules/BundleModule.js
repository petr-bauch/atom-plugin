...
class BundleModule {
    ...
    //   bundleID = result.bundleId;
		...
		const onAnalysisFinish = analysisResults => {
			setTimeout(async () => {
		...
		// buildBundleProgress (current: num, total: num)
		// buildBundleFinish (true)

		// onCreateBundleFinish (current: num, total: num)
		// onProgressBundle (true)

		// uploadBundleProgress (current: num, total: num)
		// uploadFilesFinish (true)

		//  onAnalyseProgress  (current: num, total: num)
		// + onAnalyseFinish ()
