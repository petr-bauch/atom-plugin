...
class BundleModule {
	...
	constructor() {
		...
		this.serviceAI.on(BUNDLE_EVENTS.buildBundleProgress, this.onBuildBundleProgress);
		this.serviceAI.on(BUNDLE_EVENTS.buildBundleFinish, this.onBuildBundleFinish);
		this.serviceAI.on(BUNDLE_EVENTS.uploadBundleProgress, this.onUploadBundleProgress);
		this.serviceAI.on(BUNDLE_EVENTS.uploadFilesFinish, this.onUploadBundleFinish);
		this.serviceAI.on(BUNDLE_EVENTS.analyseProgress, this.onAnalyseProgress);
		this.serviceAI.on(BUNDLE_EVENTS.analyseFinish, this.onAnalyseFinish);
