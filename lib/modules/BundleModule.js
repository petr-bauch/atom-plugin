...
class BundleModule {
	...
	constructor() {
		...
		this.buildBundleFinish = this.buildBundleFinish.bind(this);
		this.uploadBundleProgress = this.uploadBundleProgress.bind(this);
		this.uploadBundleFinish = this.uploadBundleFinish.bind(this);
		this.analyseProgress = this.analyseProgress.bind(this);
		this.analyseFinish = this.analyseFinish.bind(this);
		this.sendError = this.sendError.bind(this);

		this.serviceAI.on(BUNDLE_EVENTS.buildBundleProgress, this.buildBundleProgress);
		this.serviceAI.on(BUNDLE_EVENTS.buildBundleFinish, this.buildBundleFinish);
		this.serviceAI.on(BUNDLE_EVENTS.uploadBundleProgress, this.uploadBundleProgress);
		this.serviceAI.on(BUNDLE_EVENTS.uploadFilesFinish, this.uploadBundleFinish);
		this.serviceAI.on(BUNDLE_EVENTS.analyseProgress, this.analyseProgress);
		this.serviceAI.on(BUNDLE_EVENTS.analyseFinish, this.analyseFinish);
		this.serviceAI.on(BUNDLE_EVENTS.error, this.sendError);
	}
	...
	analyseProgress(analysisResults) {
		setTimeout(async () => {
